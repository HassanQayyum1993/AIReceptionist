...
public class GroqGenerationService : IAiService
{
    private readonly IHttpClientFactory _httpFactory;
    private readonly ILogger<GroqGenerationService> _log;
    private readonly AppSettings _settings;

    public GroqGenerationService(IHttpClientFactory httpFactory, ILogger<GroqGenerationService> log, IOptions<AppSettings> opts)
    {
